...
dispel4py multi download_FDSN.py -f download_test.json  --monitoring 'write_file monitor_download.csv' -n 6

# ####### 4. Get pre-processed synth and data --- Misfit Preprocess

dispel4py multi create_misfit_prep.py -f misfit_input.jsn  --monitoring 'write_file monitor_misfit.csv' -n 17
