...
PYTHONPATH=/Users/rosafilgueira/EPCC/DARE/dispel4py:. python -m dispel4py.new.processor multi download_FDSN.py -f download_test.json  --monitoring 'write_file monitor_download.csv' -n 6

# ####### 4. Get pre-processed synth and data --- Misfit Preprocess

PYTHONPATH=/Users/rosafilgueira/EPCC/DARE/dispel4py:. python -m dispel4py.new.processor multi create_misfit_prep.py -f misfit_input.jsn  --monitoring 'write_file monitor_misfit.csv' -n 17

# ####### 5. Get ground motion parameters and compare them

searchpath="./misfit_data/output/"
PYTHONPATH=/Users/rosafilgueira/EPCC/DARE/dispel4py:. python -m dispel4py.new.processor multi dispel4py_RA.pgm_story.py -d '{"streamProducerReal": [ {"input":"'$searchpath'" } ], "streamProducerSynth": [ {"input": "'$searchpath'"} ]}' --monitoring 'write_file monitor_pgm.csv' -n 7
