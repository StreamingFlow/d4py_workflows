...
class InternalExtinction(IterativePE):
    ...
    def _internal_extinction(self, mtype, logr25, C=0.04):
    ...
    def __init__(self):
        IterativePE.__init__(self)
        self.type_dict={"E":-5, "E-S0":-3, "S0":-2, "S0a":0, "Sa":1, "Sab":2, "Sb":3, "Sbc":4, "Sc":6, "Scd":7, "Sd":8, "Sm":9, "SBa":1, "SBab":2, "SBb":3, "SBbc":4, "SBc":6, "SBcd":7, "SBd":8, "SBm":9}
    ...
    def _process(self, data):
        ...
        try:
            t, ai = self._internal_extinction(mtype, logr25)
